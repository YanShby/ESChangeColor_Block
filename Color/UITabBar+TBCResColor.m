...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        Method Method1 = class_getInstanceMethod([UITabBar class], @selector(setBarTintColor:));
        Method newMethod1 = class_getInstanceMethod([UITabBar class], @selector(tbc_setBarTintColor:));
