...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        Method Method1 = class_getInstanceMethod([UIBarButtonItem class], @selector(setTintColor:));
        Method newMethod1 = class_getInstanceMethod([UIBarButtonItem class], @selector(tbc_setTintColor:));
