...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        Method Method1 = class_getInstanceMethod([UITextView class], @selector(setTextColor:));
        Method newMethod1 = class_getInstanceMethod([UITextView class], @selector(tbc_setTextColor:));
